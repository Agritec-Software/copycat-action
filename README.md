...
|`src_branch`|Optional|The name of the branch in source repository to clone from.|`main`|
|`dst_branch`|Optional|The name of the branch in the destination repository to push to. If the branch doesn't exists, the branch will be created based on the default branch.|`main`|
